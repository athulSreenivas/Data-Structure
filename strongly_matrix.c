...
int main()
{
    ...
    add_edge(graph, gr, 0, 1, 2);
    add_edge(graph, gr, 1, 2, 2);
    add_edge(graph, gr, 2, 3, 2);
    // add_edge(graph, gr, 2, 4, 2);
    
    add_edge(graph, gr, 3, 0, 2);

    add_edge(graph, gr, 4, 2, 2);

    add_edge(graph, gr, 4, 5, 2);

    // add_edge(graph, gr, 5, 6, 2);
    // add_edge(graph, gr, 6, 4, 2);
    // add_edge(graph, gr, 6, 7, 2);
